...
//        soxsItemDoc *item = [self.items objectAtIndex:self.tableView.indexPathForSelectedRow.row];
//    dc.detailItem = item;
...
//    return cell;
    ...
    soxsItemDoc *item = [self.items objectAtIndex:indexPath.row];
...
- (void)addTapped:(id)sender {
    soxsItemDoc *newDoc = [[soxsItemDoc alloc] initWithTitle:@"New Bug" desc:@"new desc"];
    [_items addObject:newDoc];
